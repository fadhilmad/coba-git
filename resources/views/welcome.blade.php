...
<head>
  ...
  ================================================== -->
    ...
    <link rel="stylesheet" href="{{ url('/template/blue-main/css/font-awesome.min.css') }}">
    <!-- bootstrap.min -->
    <link rel="stylesheet" href="{{ url('/template/blue-main/css/jquery.fancybox.css') }}">
    <!-- bootstrap.min -->
    <link rel="stylesheet" href="{{ url('/template/blue-main/css/bootstrap.min.css') }}">
    <!-- bootstrap.min -->
    <link rel="stylesheet" href="{{ url('/template/blue-main/css/owl.carousel.css') }}">
    <!-- bootstrap.min -->
    <link rel="stylesheet" href="{{ url('/template/blue-main/css/slit-slider.css') }}">
    <!-- bootstrap.min -->
    <link rel="stylesheet" href="{{ url('/template/blue-main/css/animate.css') }}">
    <!-- Main Stylesheet -->
    <link rel="stylesheet" href="{{ url('/template/blue-main/css/main.css') }}">
...
<body id="body">
                ...
                <div class="row">
                    ...
                    <ul class="project-wrapper wow animated fadeInUp">
                        <li class="portfolio-item">
                            ...
                            <ul class="external">
                                <li><a class="fancybox" title="Araund The world" data-fancybox-group="works"
                                        href="img/portfolio/item.jpg"><i class="fa fa-search"></i></a></li>
                        ...
                        <li class="portfolio-item">
                            ...
                            <ul class="external">
                                <li><a class="fancybox" title="Wall street" href="img/slider/banner.jpg"
                        ...
                        <li class="portfolio-item">
                            ...
                            <ul class="external">
                                <li><a class="fancybox" title="Behind The world" data-fancybox-group="works"
                                        href="img/portfolio/item3.jpg"><i class="fa fa-search"></i></a></li>
                                <li><a href=""><i class="fa fa-link"></i></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="portfolio-item">
                            ...
                            <ul class="external">
                                <li><a class="fancybox" title="Wall street 4" data-fancybox-group="works"
                                        href="img/portfolio/item4.jpg"><i class="fa fa-search"></i></a></li>
                                <li><a href=""><i class="fa fa-link"></i></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="portfolio-item">
                            ...
                            <ul class="external">
                                <li><a class="fancybox" title="Wall street 5" data-fancybox-group="works"
                                        href="img/portfolio/item5.jpg"><i class="fa fa-search"></i></a></li>
                                <li><a href=""><i class="fa fa-link"></i></a></li>
                            </ul>
                        </li>
                        ...
                        <li class="portfolio-item">
                            ...
                            <ul class="external">
                                <li><a class="fancybox" title="Wall street 6" data-fancybox-group="works"
                                        href="img/portfolio/item6.jpg"><i class="fa fa-search"></i></a></li>
                                <li><a href=""><i class="fa fa-link"></i></a></li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 wow animated fadeInRight">
                        <address class="contact-details">
                            <h3>Contact Us</h3>
                            <p><i class="fa fa-pencil"></i>Phoenix Inc.<span>PO Box 345678</span> <span>Little Lonsdale
                                    St, Melbourne </span><span>Australia</span></p><br>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="footer-content">
                    ...
                    <p>Copyright &copy; 2014-2015 Design and Developed By<a
  ...
  ================================================== -->
    <!-- Main jQuery -->
    <script src="{{ url('/template/blue-main/js/jquery-1.11.1.min.js') }}"></script>
    <!-- Twitter Bootstrap -->
    <script src="{{ url('/template/blue-main/js/bootstrap.min.js') }}"></script>
    <!-- Single Page Nav -->
    <script src="{{ url('/template/blue-main/js/jquery.singlePageNav.min.js') }}"></script>
    <!-- jquery.fancybox.pack -->
    <script src="{{ url('/template/blue-main/js/jquery.fancybox.pack.js') }}"></script>
    <!-- Google Map API -->
    <script src="http://maps.google.com/maps/api/js?sensor=false"></script>
    <!-- Owl Carousel -->
    <script src="{{ url('/template/blue-main/js/owl.carousel.min.js') }}"></script>
    <!-- jquery easing -->
    <script src="{{ url('/template/blue-main/js/jquery.easing.min.js') }}"></script>
    <!-- Fullscreen slider -->
    <script src="{{ url('/template/blue-main/js/jquery.slitslider.js') }}"></script>
    <script src="{{ url('/template/blue-main/js/jquery.ba-cond.min.js') }}"></script>
    <!-- onscroll animation -->
    <script src="{{ url('/template/blue-main/js/wow.min.js') }}"></script>
    <!-- Custom Functions -->
    <script src="{{ url('/template/blue-main/js/main.js') }}"></script>
</body>
